<script lang="ts">
  import { defense_masters_fields, defense_masters_meta } from "$lib/data";
          ...
          <tr class="transition {data.checked ? 'bg-red-600/20' : 'bg-neutral'}">
            ...
            <td class="flex flex-row justify-end">
              <NewItemMenu {endpoint} placement="bottom-end" mode={'edit'}>
                ...
                <div slot="form">
                  <input type="hidden" name="master_id" value="{data.obj.master_id}" />
